...
| Aspect | Statut |
|---|---|
| Logique de rollback (registre) | `TESTED` — 40/40 vérifications automatiques (22/09/2026, après ajout de la ruche SYSTEM WSearch/SysMain au module 47), voir `docs/TESTING.md` |
